...
namespace Kaitai
{
    ...
    public partial class KaitaiStream : BinaryReader
    {
        ...
        ///</summary>
        public KaitaiStream(string file) : base(File.Open(file, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite))
        {
        ...
        ///</summary>
        public KaitaiStream(byte[] bytes) : base(new MemoryStream(bytes, true))
        {
